...
@Component("hqbaidujisuChannelAds")
public class HuaweiQuannengBaidujisuChannelAds extends QuannengHudongReportFactory {

    String channelAdsKey = Constants.ChannelAdsKey.HUAWEI_QUANNENG_BAIDU_JISU;
    ...
    protected String serverPathKey() {
        return Constants.ServerPath.HUAWEI_QUANNENG_BAIDU_JISU;
    }
    ...
    public String findMonitorAddress() {
        ...
        //3.拼接监测地址
        return serverPath + Constants.ServerPath.HUAWEI_QUANNENG_BAIDU_JISU + Constants.ServerPath.CLICK_REPORT + "?" + macroStr;
    }
