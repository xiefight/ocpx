 ...
 */
@Component("hhChannelAds")
public class HuaweiHuihuangChannelAds extends KuaishouReportFactory {

    String channelAdsKey = Constants.ChannelAdsKey.HUAWEI_HUIHUANG;
    ...
    protected String serverPathKey() {
        return Constants.ServerPath.HUAWEI_HUIHUANG;
    }
