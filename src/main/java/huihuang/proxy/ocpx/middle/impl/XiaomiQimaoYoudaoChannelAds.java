...
@Component("xiaomiQimaoYoudaoChannelAds")
public class XiaomiQimaoYoudaoChannelAds extends XiaomiHuihuiReportFactory {
    ...
    protected String serverPathKey() {
        return Constants.ServerPath.XIAOMI_QIMAO_YOUDAO;
    }

    @Override
    protected IMarkDao adsDao() {
        return qimaoyoudaoAdsDao;
    }
