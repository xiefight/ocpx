...
@Component("xqjrttChannelAds")
public class XiaomiQuannengJinritoutiaoChannelAds extends QuannengHudongReportFactory {
    ...
    protected String serverPathKey() {
        return Constants.ServerPath.XIAOMI_QUANNENG_JINRITOUTIAO;
    }
    ...
    public String findMonitorAddress() {
        ...
        //3.拼接监测地址
        return serverPath + Constants.ServerPath.XIAOMI_QUANNENG_JINRITOUTIAO + Constants.ServerPath.CLICK_REPORT + "?" + macroStr;
    }
