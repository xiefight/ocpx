...
@Component("hqjrttChannelAds")
public class HuaweiQuannengJinritoutiaoChannelAds extends QuannengHudongReportFactory {
    ...
    protected String serverPathKey() {
        return Constants.ServerPath.HUAWEI_QUANNENG_JINRITOUTIAO;
    }
    ...
    public String findMonitorAddress() {
        ...
        //3.拼接监测地址
        return serverPath + Constants.ServerPath.HUAWEI_QUANNENG_JINRITOUTIAO + Constants.ServerPath.CLICK_REPORT + "?" + macroStr;
    }
