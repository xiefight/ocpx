...
public class HuaweiQuannengFanqieChannelAds extends QuannengHudongReportFactory {
    ...
    public String findMonitorAddress() {
        ...
        //3.拼接监测地址
        return serverPath + Constants.ServerPath.HUAWEI_QUANNENG_FANQIE + Constants.ServerPath.CLICK_REPORT + "?" + macroStr;
    }
