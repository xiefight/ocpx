...
public class BaiduQuannengXiguaVideoChannelAds extends QuannengHudongReportFactory {
    ...
    public String findMonitorAddress() {
        ...
        //3.拼接监测地址
        return serverPath + Constants.ServerPath.BAIDU_QUANNENG_XIGUA_VIDEO + Constants.ServerPath.CLICK_REPORT + "?" + macroStr;
    }
