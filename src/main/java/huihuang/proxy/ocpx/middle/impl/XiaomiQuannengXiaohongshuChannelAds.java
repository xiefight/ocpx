...
public class XiaomiQuannengXiaohongshuChannelAds extends QuannengHudongReportFactory {
    ...
    public String findMonitorAddress() {
        ...
        //3.拼接监测地址
        return serverPath + Constants.ServerPath.XIAOMI_QUANNENG_XIAOHONGSHU + Constants.ServerPath.CLICK_REPORT + "?" + macroStr;
    }
