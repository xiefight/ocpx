...
@Component("xqiqyChannelAds")
public class XiaomiQuannengIQiyiChannelAds extends QuannengHudongReportFactory {
    ...
    protected String serverPathKey() {
        return Constants.ServerPath.XIAOMI_QUANNENG_IQIYI;
    }
    ...
    public String findMonitorAddress() {
        ...
        //3.拼接监测地址
        return serverPath + Constants.ServerPath.XIAOMI_QUANNENG_IQIYI + Constants.ServerPath.CLICK_REPORT + "?" + macroStr;
    }
