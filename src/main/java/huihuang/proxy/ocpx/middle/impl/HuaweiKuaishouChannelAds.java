...
public class HuaweiKuaishouChannelAds extends BaseSupport implements IChannelAds {
...
//        signature(kuaishouParamField);
    ...
    protected void replaceCallbackUrl(Object adsObj, Object adsDtoObj) {
        ...
        String ocpxUrl = queryServerPath() + Constants.ServerPath.HUAWEI_KUAISHOU + Constants.ServerPath.ADS_CALLBACK + "/" + kuaishouAdsDTO.getId() + "?";
