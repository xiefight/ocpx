...
public class BaiduHuihuangTianmaoChannelAds extends HuihuangMingtianReportFactory {
    ...
    public String findMonitorAddress() {
        ...
        //3.拼接监测地址
        return serverPath + Constants.ServerPath.BAIDU_HUIHUANG_TIANMAO + Constants.ServerPath.CLICK_REPORT + "?" + macroStr;
    }
