...
public class HuaweiHuihuangDouyinhuoshanChannelAds extends HuihuangMingtianReportFactory {
    ...
    public String findMonitorAddress() {
        ...
        //3.拼接监测地址
        return serverPath + Constants.ServerPath.HUAWEI_HUIHUANG_DOUYINHUOSHAN + Constants.ServerPath.CLICK_REPORT + "?" + macroStr;
    }
