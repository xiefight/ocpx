package huihuang.proxy.ocpx.ads.huihuangkuake;
...
public enum HuihuangKuakeParamEnum {
    ...
    HuihuangKuakeParamEnum(String name, String type, Integer necessary, String remark) {
        this.name = name;
        this.type = type;
    ...
    public static Map<HuihuangKuakeParamEnum, HuaweiParamEnum> huihuangmingtianHuaweiMap;
    ...
    public static Map<HuihuangKuakeParamEnum, BaiduParamEnum> huihuangmingtianBaiduMap;
    ...
    public static Map<HuihuangKuakeParamEnum, XiaomiParamEnum> huihuangmingtianXiaomiMap;
    ...
    public static Map<HuihuangKuakeParamEnum, IQiyiParamEnum> huihuangmingtianIQiyiMap;
    ...
    public static Map<HuihuangKuakeParamEnum, HonorParamEnum> huihuangmingtianHonorMap;
